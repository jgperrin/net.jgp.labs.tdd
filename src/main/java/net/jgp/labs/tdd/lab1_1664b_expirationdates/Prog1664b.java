...
public class Prog1664b {
	public static void main(String[] args) {
		...
		// launch the Prog1664b constructor
		Prog1664b app = null;
		app = new Prog1664b();
	...
	// the private void method code contains the necessary used inside for
	// encoding/encoding (main structure)
	private void start() {
		...
		while (stopLoop) {
			...
			// print the following as grid-like output (and the choice user
			// makes) and ask user for function necessary
	...
	public String encode(String dateAsString) {
		...
		// the code is then transformed to be with letters based on each digit
		// and year (character ASCII arithmetic)
	...
	public String decode(String code) {
		...
		// Month encoding - if the first character is less than A or more than L
		if (code.charAt(0) < 'A' || code.charAt(0) > 'L') {
			// throw new NumberFormatException
			throw new NumberFormatException(
					"The character should be between A and L, " + code.charAt(0) + " was provided");
		}

		// if the second character is less than Q or more than S and not 0
		if ((code.charAt(1) < 'Q' || code.charAt(1) > 'Z') && code.charAt(1) != '0') {
			// throw new NumberFormatException
			throw new NumberFormatException(
					"The character should be between Q and Z, " + code.charAt(1) + " was provided");
		}

		// if the third character is less than Q or more than Z
		if (code.charAt(2) < 'P' || code.charAt(2) > 'Z') {
			// throw new NumberFormatException
			throw new NumberFormatException(
					"The character should be between Q and Z, " + code.charAt(2) + " was provided");
		}
		...
		if (code.charAt(3) < 'A' || code.charAt(3) > 'Z') {
			// throw new NumberFormatException
			throw new NumberFormatException(
					"The character should be between A and Z, " + code.charAt(3) + " was provided");
		}
...
/*
 * Sample Output ----menu---- 0) Quit 1) Encode Date 2) Decode Date Select an
 * option: 2 Enter code: IQTN The date is: 9/14/1983 Do you want to continue
 * (Y/N): Y
 * 
 * ----menu---- 0) Quit 1) Encode Date 2) Decode Date Select an option: 1 Enter
 * date (m/d/y) 1/1/75
 * 
 * The code is A0QV Do you want to continue (Y/N): N
 * 
 * ----menu---- 0) Quit 1) Encode Date 2) Decode Date Select an option: 2 Enter
 * code: AQTM The date is: 1/14/1984 Do you want to continue (Y/N): Y
 * 
 * ----menu---- 0) Quit 1) Encode Date 2) Decode Date Select an option: 1 Enter
 * date (m/d/y) 9/14/83
 * 
 * The code is IQTN Do you want to continue (Y/N): N
 * 
 * ----menu---- 0) Quit 1) Encode Date 2) Decode Date Select an option: 1 Enter
 * date (m/d/y) 1/14/84
 * 
 * The code is AQTM Do you want to continue (Y/N): Y
 * 
 * ----menu---- 0) Quit 1) Encode Date 2) Decode Date Select an option: 2 Enter
 * code: A0QV The date is: 1/1/1975 Do you want to continue (Y/N): Y
 * 
 * ----menu---- 0) Quit 1) Encode Date 2) Decode Date Select an option: 2 Enter
 * code: K0RH The date is: 11/2/1989 Do you want to continue (Y/N): Y
 * 
 * ----menu---- 0) Quit 1) Encode Date 2) Decode Date Select an option: 0
 * 
 */